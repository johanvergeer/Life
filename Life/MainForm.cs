...
namespace Life
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            // Species maken
            LifeApplication.CreateSpecies("Dog", 30, 4, Digestion.OmnivorePlant, 20, 60, 10, 100, 0, 95, 20);
            LifeApplication.CreateSpecies("Kat", 30, 4, Digestion.Carnivore, 20, 60, 10, 100, 0, 95, 20);
            LifeApplication.CreateSpecies("Giraffe", 30, 4, Digestion.Herbivore, 20, 60, 10, 100, 0, 95, 20);
            LifeApplication.CreateSpecies("Niksnut", 30, 4, Digestion.Nonivore, 20, 60, 10, 100, 0, 95, 20);
            LifeApplication.CreateSpecies("Mens", 30, 4, Digestion.OmnivoreCreature, 20, 60, 10, 100, 0, 95, 20);
        }
